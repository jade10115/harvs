              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  <div class="form-group field-wrapper">
                    ...
                    <input type="text" class="form-control" name="m_name" placeholder="Middle Name (Optional)">
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group field-wrapper">
                    ...
                    <input type="text" class="form-control" name="suffix_name" placeholder="Suffix Name (Optional)">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group field-wrapper">
                    <label for="ext_name">Extension Name <small>(Optional)</small></label>
                    <input type="text" class="form-control" name="ext_name" placeholder="Extension Name (Optional)">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group fixlabel">
