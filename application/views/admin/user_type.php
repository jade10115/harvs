  ...
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-4 px-4 mb-3">
      <div class="card shadow-sm">
          ...
          <?=$title?>
          <a href="#" class="btn btn-outline-dark btn-sm" data-toggle="modal" data-target="#modal_building_add">Add User Type</a>  
        </h5>
			  <div class="card-body">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?=form_open('admin/updateBuilding', 'id="frm_building_update"');?>
          ...
          <div class="form-group">
            <label>User Type</label>
            <input type="text" class="form-control focus" placeholder="Enter Building Name" name="user_type" id="user_type" required>
          </div>
        <?=form_close();?>
      </div>
      <div class="modal-footer">
